...
## Τρόπος λειτουργίας / Τεχνικά στοιχεία
...
Αριστερά υπάρχει μια ξύλινη επίπεδη κατασκευή η οποία στέκεται όρθια με μια βάση
που ανοίγει με περιστροφή και με ράφια τα οποία ανοίγουν. Τα ράφια διαθέτουν στο
...
με το προηγούμενο μέρος η οποία διαθέτει αντίστοιχη βάση και στην οποία οι
